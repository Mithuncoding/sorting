...
const LandingPage: React.FC = () => {
  ...
  return (
    ...
    >
        ...
        {ORBS.map((orb) => (
          <motion.div
            ...
            style={{
              ...
              width: orb.size,
              height: orb.size,
              background: `radial-gradient(circle, ${orb.size > 400 ? orb.color + '10' : orb.color + '05'}, transparent 70%)`,
              filter: `blur(80px)`,
            }}
            animate={{
              x: [0, 50, -30, 0],
      ...
      >
        {/* Badge with Shield and Sparkles */}
        <motion.div
        ...
        >
          ...
          <span className="text-xs sm:text-sm font-semibold tracking-widest uppercase flex items-center gap-2">
            9+ Algorithms • Secured Engine <Shield className="w-3.5 h-3.5 inline text-[#00ff88]" />
          </span>
          <Sparkles className="w-4 h-4 animate-pulse group-hover:scale-110 transition-transform" />
        </motion.div>
            ...
            <div className="p-6 sm:p-8">
              <div className="flex flex-col sm:flex-row items-center gap-8">
                ...
                <div className="flex-1 w-full grid grid-cols-2 gap-3">
                  <StatBox label="Comparisons" value="120" color="#00f3ff" />
                  <StatBox label="Swaps" value="45" color="#ff00ea" />
                  <StatBox label="Time" value="O(n²)" color="#9d00ff" />
                  <StatBox label="Status" value="Sorting..." color="#00f3ff" isLive />
                </div>
              </div>
            </div>
          </div>
